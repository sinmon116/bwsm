...
$codepay_config['uid'] = $_SESSION['think']['uid'];
$codepay_config['user'] = $_SESSION['think']['uname']; //这是默认的充值用户 因为我们演示的数据库充值 只有该用户名 如正式使用请为空
