    ...
    <section class="clearfix g-member">
        <div class="g-Recharge">
            <ul id="ulOption">
                ...
                <li money="0.10"><a href="javascript:;" class="z-sel">0.10元/3天<s></s></a></li>
                <li money="0.20"><a href="javascript:;">0.20元/10天<s></s></a></li>
                <li money="0.30"><a href="javascript:;">0.30元/月<s></s></a></li> <!--class="z-sel" 表示默认选中50元-->
            ...
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li  class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值：<label
                            ...
                            <input type="text" name="price" id="price" placeholder="如：0.10" value="0.10"
