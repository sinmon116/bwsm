<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"F:\bwsmtp5\public/../application/admin\view\admingl\admincate.html";i:1518095191;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>权限分类</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
            <table class="layui-table">
                ...
                <tbody id="x-link">
                    <tr>
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="cate_edit('编辑','/admin/admingl/cateedit','4','','510')"
