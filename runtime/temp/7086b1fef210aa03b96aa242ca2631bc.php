<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/index/view/video/gd.html";i:1518948396;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="general-agileits-w3l">
		<div class="w3l-medile-movies-grids">
				      ...
				      <div class="movie-browse-agile">
						...
						<div class="browse-agile-w3ls general-w3ls">
								<div class="tittle-head">
									<h4 class="latest-text"><?php echo $name; ?></h4>
									<div class="container">
										<div class="agileits-single-top">
											<ol class="breadcrumb">
											  <li><a href="/">Home</a></li>
											  <li><a href="/index/video/tv/cid/<?php echo $fcid; ?>"><?php echo $dname; ?></a></li>
							...
							<?php foreach($data as $val): ?>
									<div class="col-md-2 w3l-movie-gride-agile">
										 <a href="/index/video/single/vid/<?php echo $val['vid']; ?>" class="hvr-shutter-out-horizontal"><img src="<?php echo $val['fengmian']; ?>" title="album-name" style="width: 100%;height: 200px;" />
				...
				<!--//browse-agile-w3ls -->
						<div class="row" style="margin-left: 38%;"><?php echo $page; ?></div>
				    <!-- //movie-browse-agile -->
				   <!--body wrapper start-->
