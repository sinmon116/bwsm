<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/admin/view/videoclass/bannerlist.html";i:1518948396;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="x-body">
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="banner_add('视频上传','/admin/videoclass/banneradd','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
            <table class="layui-table">
				...
				<?php foreach($list as $val): ?>
                    <tr>
                        ...
                        <td>
                            <img  src="<?php echo $val['fengmian']; ?>" width="240" height='100' alt="点击图片试试">
                        </td>
                        <td >
                           <?php echo $val['title']; ?>
                        </td>
                        ...
                        <td class="td-manage">
							...
							<?php if($val['isdel']==1): ?>
							<a href="/admin/videoclass/isdel/id/<?php echo $val['vid']; ?>/isdel/0">解除</a>
							<?php else: ?>
							<a href="/admin/videoclass/isdel/id/<?php echo $val['vid']; ?>/isdel/1">屏蔽</a>
							<?php endif; ?>
                        </td>
                    </tr> 
					<?php endforeach; ?>
