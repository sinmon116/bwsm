<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\bwsmtp5\public/../application/index\view\user\person.html";i:1518660325;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="faq">
			...
			<div class="container">
				...
				<div style="width: 98%;height:400px;-border:1px solid gray;display: none;" id='box' >
					<!-- 头像位置 -->
					<div style="width: 150px;height: 150px;background: red;float: left;margin-top:110px;margin-left: 30px;">
					...
					<div style="width: 450px;height: 158px;float: right;margin-top: -100px;">
						...
						<div style="width: 300px;height: 30px;border: 1px solid #DBDBDB;border-radius: 20px;margin: 0 auto;margin-top: 10px;margin-bottom: 10px;background:#EDEEED;">
							<div style="height: 100%;background: #F1C50E;border-radius: 20px;text-align: right;line-height: 30px;" id="shu">
								20%
							</div>
							<script type="text/javascript">
								tianshu();
				...
				<div  style="width: 98%;height:288px;-border:1px solid gray;display: none;margin-top: 66px;" id='vipbox' >
					<div style="    width: 70%;height: 392px;-background: red;margin: 0 auto;">
						...
						<div style="    float: right;margin-top: -43px;margin-right: 237px;"><a href="">点击充值VIP 享受尊贵特权</a></div>
					</div>
