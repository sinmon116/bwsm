<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/admin/view/comment/commentlist.html";i:1518948396;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="x-body">
            ...
            <table class="layui-table">
				...
				<?php foreach($data as $val): ?>
					...
					<?php else: ?>
						<td>
						<?php $__FOR_START_519897826__=1;$__FOR_END_519897826__=$val['level'];for($i=$__FOR_START_519897826__;$i < $__FOR_END_519897826__;$i+=1){ ?>|---<?php } ?><?php echo $val['concent']; ?>
						</td>
					<?php endif; ?>
