<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/admin/view/quest/questionlist.html";i:1518948396;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>问题·留言</button><span class="x-right" style="line-height:40px">共有数据:<?php echo $count; ?>条</span></xblock>
		...
		<script>
			...
			var aA   = document.getElementsByClassName('aa');
				...
				//创建tr
					...
					// 给每个td赋值
					oTd1.innerHTML = obj[i].qid;
					oTd2.innerHTML = obj[i].content;
					oTd3.innerHTML = obj[i].uname;
					oTd4.innerHTML = obj[i].create_time;
