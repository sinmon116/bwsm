<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\PHP\php\bwsmtp5\public/../application/admin\view\comment\commentlist.html";i:1517823431;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="x-body">
            ...
            <table class="layui-table">
				...
				<?php foreach($data as $val): ?>
					...
					<?php else: ?>
						<td>
						<?php $__FOR_START_24355__=1;$__FOR_END_24355__=$val['level'];for($i=$__FOR_START_24355__;$i < $__FOR_END_24355__;$i+=1){ ?>|---<?php } ?><?php echo $val['concent']; ?>
						</td>
					<?php endif; ?>
