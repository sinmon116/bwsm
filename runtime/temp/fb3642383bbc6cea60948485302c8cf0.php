<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/index/view/video/single.html";i:1519866085;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					...
					<?php else: ?>
						...
						<!-- 这个是为了得到是否是vip的字段 -->
						<input type="hidden" value="<?php echo \think\Session::get('isvip'); ?>" id="vippanduan" />
							<!-- 这里是广告 -->
							<div style="width: 100%;height: 460px;display: block;background: #000;position: relative;" class="a">

								<!-- 这里是播放广告的video -->
								<video style="height: 100%;width: 100%;" src="http://<?php echo $gurl; ?>" id="a">
								</video>
								<!-- 这里是广告倒计时信息 -->
								<div style="width: 100px;height: 100px;position: absolute;top: 0;right: 0;">
									<div style="width: 50px;height: 50px;background: blue;float: right;margin-top: 25px;text-align: center;line-height: 50px;border-radius: 50%;" id="gg">9</div>
									<p style="width: 50px;height: 50px;background: bisque;margin-top: 25px;text-align: center;line-height: 50px;">广告</p>
									<script>

									// 得到是否当前vip字段
										var vippanduan = $('#vippanduan').val();
									// 如果当前vip字段为2时则无广告
										if (vippanduan == 2) {
										// sj是广告倒计时
											var sj = 0;
							...
							<div style="width: 100%;height: 460px;display: none;"  data-video="dLmKio67pVQ" id="video" class="b">
								<div class="demo">
					                <div id="danmup" style="margin:20px auto"></div>
					            </div>
					            ...
					            // 直接播放广告
									$('#a')[0].play();
								// 计时器：当广告播放结束时隐藏广告的div，展示当前视频的div
