<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/admin/view/admingl/adminadd.html";i:1518948396;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <script src="/static/admin/js/x-layui.js" charset="utf-8">
			...
			$(function(){
				$('#btn').click(function(){
					...
					$.ajax({
						type:'post',
						url:'/admin/admingl/adminuser',
						data:{username:username,phone:phone,email:email,select:select,pas1:pwd},
						dataType:'json',
						success:success
					});
				})
