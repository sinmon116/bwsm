<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"F:\bwsmtp5\public/../application/admin\view\admingl\adminrule.html";i:1518156196;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn layui-btn-danger" ><i class="layui-icon"></i>权限管理</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
            <table class="layui-table">
				...
				<?php foreach($limit as $val): ?>
                    <tr>
						...
						<?php else: ?>
						<td>
						<?php $__FOR_START_12967__=1;$__FOR_END_12967__=$val['level'];for($i=$__FOR_START_12967__;$i < $__FOR_END_12967__;$i+=1){ ?>|----------<?php } ?><?php echo $val['name']; ?>
						</td>
						<?php endif; ?>
