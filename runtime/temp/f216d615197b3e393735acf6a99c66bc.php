<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/home/wwwroot/tp.chenjiangjiang.cn/public/../application/admin/view/index/index.html";i:1519817436;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                    ...
                    <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                 ...
                                 <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="/admin/videoclass/guanggao">
                                            <cite>广告列表</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="/admin/vip/order">
                                            <cite>订单列表</cite>
                                        </a>
                                    </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <!-- </dd> -->
                                <dd class="">
                                    <a href="javascript:;" _href="/admin/echarts/echarsb">
                                        <cite>饼图</cite>
                                    </a>
                                </dd>
								 <dd class="">
